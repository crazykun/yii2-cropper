...
switch ($jsOptions['pos']) {
    default:
    case View::POS_END:
        \coldlook\cropper\CropperAsset::register($this);
        break;
    case View::POS_BEGIN:
        \coldlook\cropper\CropperBeginAsset::register($this);
        break;
    case View::POS_HEAD:
        \coldlook\cropper\CropperHeadAsset::register($this);
        break;
    case View::POS_LOAD:
        \coldlook\cropper\CropperLoadAsset::register($this);
        break;
    case View::POS_READY:
        \coldlook\cropper\CropperReadyAsset::register($this);
        break;
}
